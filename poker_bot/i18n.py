...
RU_CATALOG = Catalog(
    ...
    messages={
        ...
        "help_text": (
            ...
            "Монетизация:\n"
            "• в каждом чате доступны 3 бесплатные игры\n"
            "• после исчерпания бесплатных игр нужна подписка пользователя для /newgame\n"
        ...
        "limits_status": (
            ...
            "Новых игр по вашей подписке осталось: {subscription_games_left}"
        ),
