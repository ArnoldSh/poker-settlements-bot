...
RU_CATALOG = Catalog(
    ...
    messages={
        ...
        "start_text": (
            ...
            "В каждом чате доступны 3 бесплатных финализации игр через /calc.\n"
        ...
        "help_text": (
            ...
            "• подписка считается на пользователя и даёт до {subscription_games_limit} новых игр за период подписки\n"
